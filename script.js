...
function yes() {
    ...
    question.textContent = "siiiiii, Vamos a cenar. Yo invito Ñam Ñam"
    gif.src = 'assets/4cartas-para-el-14-de-febrero-ezgif.com-optimize.gif'
...
var phrase = ['Ayyy, por que no?', 'No quieres?:(', 'De verdad no quieres :( ?', 'Di que si, por fa!', 'Shiii????']
var gifs = ['assets/hug-me-im-sad.gif', 'assets/goma-peach.gif', 'assets/pokemon-pikachu.gif', 'assets/sad.gif', 'assets/cry-cute.gif', 'assets/reaction-sad.gif']
var noCount = 0
